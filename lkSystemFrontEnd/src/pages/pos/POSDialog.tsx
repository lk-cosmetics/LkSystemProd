...
const SIZE_CLASSES: Record<DialogSize, string> = {
  ...
  default: 'sm:max-w-[760px]',
  payment: 'sm:max-w-[820px]',
};
...
export function POSDialogContent({
  ...
  return (
    <DialogContent
      className={cn(
        'flex max-h-[calc(100dvh-1rem)] w-[calc(100vw-1rem)] flex-col overflow-hidden rounded-lg p-0 shadow-xl sm:max-h-[85dvh]',
        SIZE_CLASSES[size],
        className
      )}
      {...props}
...
export function POSDialogHeader({
  ...
  return (
    <DialogHeader className="shrink-0 border-b px-5 py-5 text-left sm:px-7 sm:py-6">
...
export function POSDialogFooter({
  ...
  return (
    <div
      className={cn(
        'flex shrink-0 flex-col-reverse gap-3 border-t bg-background px-5 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-7',
        className
      )}
      {...props}
    />
...
export function POSPrimaryButton({
  ...
  return (
    <Button
      className={cn('h-12 min-w-48 px-6 text-sm font-semibold', className)}
      {...props}
    />
  );
}
...
export function POSSecondaryButton({
  ...
  return (
    <Button
      variant="outline"
      className={cn('h-12 px-5 text-sm font-medium', className)}
      {...props}
    />
  );
}
...
export function POSActionCard({
  ...
  return (
    <button
      type="button"
      className={cn(
        'flex min-h-24 w-full items-center gap-4 rounded-md border bg-background p-4 text-left outline-none transition-colors',
    ...
    >
      <span
        className={cn(
          'flex size-11 shrink-0 items-center justify-center rounded-md border bg-muted/40',
