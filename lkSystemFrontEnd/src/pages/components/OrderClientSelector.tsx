  ...
  if (value) {
    ...
    return (
      <div className="rounded-lg border bg-muted/30 p-3">
        ...
        {value.is_blocked && (
          <div className="mt-2 flex items-start gap-2 rounded-md border border-red-300 bg-red-50 px-2.5 py-2 text-xs dark:border-red-500/40 dark:bg-red-500/10">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-0.5 break-words text-red-700/90 dark:text-red-300/80">
                {value.blocked_reason || 'No reason provided.'} Review before completing the order.
              </p>
            </div>
          </div>
        )}
